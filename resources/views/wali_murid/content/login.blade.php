    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(../assets/images/ex-header-background.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" method="post" action="/postlogin">
                    @csrf
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                Belum punya akun? <a href="register" class="text-info m-l-5"><b>Daftar</b></a>
                            </div>
                        </div>
                    </form>
